var prefilterVert = `#version 300 es
...
var prefilterFrag = `#version 300 es
...
class PrefilterMaterial {
	render(gl, model, mvpMatrix, enviromentMap, roughness) {
		...
		gl.uniform1f(this.shaderProgram.roughness, roughness);
	...
	init(gl) {
		var vertexShader = getShader(prefilterVert, "x-shader/x-vertex");
		var fragmentShader = getShader(prefilterFrag, "x-shader/x-fragment");
	    ...
	    this.shaderProgram.enviromentMap = gl.getUniformLocation(this.shaderProgram, "environmentMap");
	    this.shaderProgram.roughness = gl.getUniformLocation(this.shaderProgram, "roughness");
